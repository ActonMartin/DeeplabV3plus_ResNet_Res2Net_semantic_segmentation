...
labels = [
    ...
    Label(  'aeroplane'            ,  1 ,      255 , 'void'            , 0       , False        , True         , (128, 0, 0) ),
    Label(  'bicycle'              ,  2 ,      255 , 'void'            , 0       , False        , True         , (0, 128, 0) ),
    Label(  'bird'                 ,  3 ,      255 , 'void'            , 0       , False        , True         , (128, 128, 0) ),
    Label(  'boat'                 ,  4 ,      255 , 'void'            , 0       , False        , True         , (0, 0, 128) ),
    Label(  'bottle'               ,  5 ,      255 , 'void'            , 0       , False        , True         , (128, 0, 128) ),
    Label(  'bus'                  ,  6 ,      255 , 'void'            , 0       , False        , True         , (0, 128, 128) ),
    Label(  'car'                  ,  7 ,        0 , 'flat'            , 1       , False        , False        , (128, 128, 128) ),
    Label(  'cat'                  ,  8 ,        1 , 'flat'            , 1       , False        , False        , (64, 0, 0) ),
    Label(  'chair'                ,  9 ,      255 , 'flat'            , 1       , False        , True         , (192, 0, 0) ),
    Label(  'cow'                  , 10 ,      255 , 'flat'            , 1       , False        , True         , (64, 128, 0) ),
    Label(  'diningtable'          , 11 ,        2 , 'construction'    , 2       , False        , False        , (192, 128, 0) ),
    Label(  'dog'                  , 12 ,        3 , 'construction'    , 2       , False        , False        , (64, 0, 128) ),
    Label(  'horse'                , 13 ,        4 , 'construction'    , 2       , False        , False        , (192, 0, 128) ),
    Label(  'motorbike'            , 14 ,      255 , 'construction'    , 2       , False        , True         , (64, 128, 128) ),
    Label(  'person'               , 15 ,      255 , 'construction'    , 2       , False        , True         , (192, 128, 128) ),
    Label(  'potted plant'         , 16 ,      255 , 'construction'    , 2       , False        , True         , (0, 64, 0) ),
    Label(  'sheep'                , 17 ,        5 , 'object'          , 3       , False        , False        , (128, 64, 0) ),
    Label(  'sofa'                 , 18 ,      255 , 'object'          , 3       , False        , True         , (0, 192, 0) ),
    Label(  'train'                , 19 ,        6 , 'object'          , 3       , False        , False        , (128,192, 0) ),
    Label(  'tv/monitor'           , 20 ,        7 , 'object'          , 3       , False        , False        , (0,64, 128) ),
]
